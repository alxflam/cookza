...
void main() {
  ...
  test('Calculate ingredients for ingredient with plural and singular entry',
      () async {
    var recipe = RecipeCreator.createRecipe('First Recipe');
    recipe.servings = 2;
    var oneApple =
        RecipeCreator.createIngredient('Apple', amount: 1, uom: 'H87');
    var someApples =
        RecipeCreator.createIngredient('Apples', amount: 5, uom: 'H87');
